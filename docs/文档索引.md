...
- **[国内HF镜像站与替代平台指南.md](国内HF镜像站与替代平台指南.md)** - 国内镜像站现状与替代平台对比（含 `HF_HUB_DISABLE_XET=1` 关键解法）
...
- **[P3集成测试报告.md](P3集成测试报告.md)** - P3 集成测试报告（100% 通过）⭐

### 历史测试报告

- [P2测试报告.md](reports/P2测试报告.md) - P2 测试报告
- [P1测试进度.md](reports/P1测试进度.md) - P1 测试进度
- [P0测试报告.md](reports/P0测试报告.md) - P0 测试报告
- [优化器修复与P3测试.md](reports/优化器修复与P3测试.md) - 优化器修复和 P3 测试
- [XET_Hash提取改进方案.md](reports/XET_Hash提取改进方案.md) - Hash 提取改进设计
- [XET_Hash改进总结.md](reports/XET_Hash改进总结.md) - Hash 提取改进总结

### 开发者资源

- [dev/已知问题.md](dev/已知问题.md) - 已知问题跟踪
- [dev/测试计划.md](dev/测试计划.md) - 测试计划
- [dev/HOST优选器设计.md](dev/HOST优选器设计.md) - HOST 优选器设计
- [dev/HOST优选器完整分析.md](dev/HOST优选器完整分析.md) - HOST 优选器完整分析
...
- **[XET.SPEC.md](spec/XET.SPEC.md)** - XET 协议完整规范（含 CDC、哈希、Xorb、Shard、上传/下载协议）⭐
- **[XET.API.md](spec/XET.API.md)** - XET API 完整参考（Hub API 27 端点 + CAS API 4 端点）⭐
...
- **[shard_api_spec.md](shard_api_spec.md)** - Shard API 实战验证与全局去重规则修正报告
...
### 想了解最新测试结果？
→ [reports/P3集成测试报告.md](reports/P3集成测试报告.md) ⭐
